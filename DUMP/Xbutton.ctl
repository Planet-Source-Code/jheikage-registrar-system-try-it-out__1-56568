...
Begin VB.UserControl chameleonButton 
   ...
   PropertyPages   =   "Xbutton.ctx":030A
   ScaleHeight     =   48
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   203
   ToolboxBitmap   =   "Xbutton.ctx":033F
...
With PropBag
    ...
    Call .WriteProperty("INAME", UserControl.FontName)
    Call .WriteProperty("SIZE", UserControl.FontSize)
