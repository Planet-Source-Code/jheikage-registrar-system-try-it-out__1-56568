...
Begin VB.Form MainForm 
   ...
   Begin TabDlg.SSTab STAB 
      ...
      TabPicture(0)   =   "MainForm.frx":19EBA
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "LVSubjects"
      Tab(0).Control(1)=   "FrmSub"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "SECTIONS"
      TabPicture(1)   =   "MainForm.frx":19ED6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "LVSection"
      Tab(1).Control(1)=   "Frmsec"
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "TEACHERS"
      TabPicture(2)   =   "MainForm.frx":19EF2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "LVTeachers"
      Tab(2).Control(1)=   "FrmTeach"
      Tab(2).ControlCount=   2
      TabCaption(3)   =   "ROOMS"
      TabPicture(3)   =   "MainForm.frx":19F0E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "LVRooms"
      Tab(3).Control(1)=   "FrmR"
      Tab(3).ControlCount=   2
      TabCaption(4)   =   "SCHEDULES"
      TabPicture(4)   =   "MainForm.frx":19F2A
      ...
      Begin VB.Frame Pback 
         ...
         Begin VB.ComboBox TOUT 
            Height          =   360
            ItemData        =   "MainForm.frx":19F46
            Left            =   675
            List            =   "MainForm.frx":19FA1
         ...
         Begin VB.ComboBox CBView 
            Height          =   360
            ItemData        =   "MainForm.frx":1A0B0
            Left            =   1200
            List            =   "MainForm.frx":1A0BD
            Style           =   2  'Dropdown List
            TabIndex        =   137
            Top             =   300
            Width           =   1365
         ...
         Begin VB.ComboBox CBSelect 
            Height          =   360
            ItemData        =   "MainForm.frx":1A0D7
            Left            =   3900
            List            =   "MainForm.frx":1A0DE
            TabIndex        =   136
            Text            =   "SELECT DATA"
            Top             =   300
            Width           =   1665
         ...
         Begin VB.ComboBox TIN 
            Enabled         =   0   'False
            Height          =   360
            ItemData        =   "MainForm.frx":1A0E7
            Left            =   0
            List            =   "MainForm.frx":1A142
            Style           =   2  'Dropdown List
            TabIndex        =   257
            Top             =   0
            Visible         =   0   'False
...
Private Sub TSem_Change()
    ...
    Case "0"
        LblCaps.Caption = "Regular"
    Case ""
        
    Case Else
        MsgBox "Enter 1 or 2 only.", vbCritical, "Error"
        TSem.SetFocus
    End Select
