...
Begin VB.Form FrmAddNeed 
   ...
   Begin VB.PictureBox PSec 
      ...
      Begin VB.ComboBox CBYrsec 
         Height          =   360
         ItemData        =   "FrmAddNeed.frx":5808
         Left            =   3825
         List            =   "FrmAddNeed.frx":581B
         Style           =   2  'Dropdown List
         TabIndex        =   20
         Top             =   450
         Width           =   690
      ...
      Begin VB.ComboBox CBCoursesec 
         Height          =   360
         ItemData        =   "FrmAddNeed.frx":582E
         Left            =   1650
         List            =   "FrmAddNeed.frx":5841
         Style           =   2  'Dropdown List
         TabIndex        =   18
         Top             =   450
         Width           =   1740
...
'FIXIT: Replace 'Trim' function with 'Trim$' function                                      FixIT90210ae-R9757-R1B8ZE
TSectionsec.Text = Trim(CBCoursesec.Text) & Trim(CBYrsec.Text)
End Sub
